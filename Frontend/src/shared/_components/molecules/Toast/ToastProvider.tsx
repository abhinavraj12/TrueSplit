 ...
 * Each function maps to a specific type and default duration.
 */
export const toast = {
  success: (
    message: string,
...
/**
 * ToastProvider component that wraps your app and renders the Toaster.
 * Also provides the toast functions via the toast object.
 */
